    ...
    $.ajax({
        ...
        success:function(data){
            ...
            $("#clientslisttable").DataTable({
               ...
               {mRender:function(){
               var deletebtn = "<a class='' onclick='deleteclient($(this))'><img src='http://localhost/support/assets/images/icons/delete.png' width='20px' height='20px'></a>";
               return deletebtn;
                   }},
               {data:"client_no"},
               {data:"clientname"},
         ...
         var i=0;
          ...
          i++;});
           ...
           $.ajax({
                   ...
                   $.each(data,function(index,value){
                              var deleteicon = "<a class='deleterow' onclick='deleterow($(this))'><img src='http://localhost/support/assets/images/icons/delete.png' width='20px' height='20px'></a>";
            ...
            grandtotal  = ((parseFloat(grandtotal)+subtotal)*(1 + (parseFloat(value.vat)/100))).toFixed(2);
              var tr = "<tr><td>"+deleteicon+"</td><td>"+i+"</td><td class='itemid'>"+value.id+"</td><td contenteditable='true'>"+value.partno+"</td><td class='description' contenteditable='true'>"+value.description+"</td><td contenteditable='true'>"+value.qty+"</td><td contenteditable='true'>"+value.unitbp+"</td><td contenteditable='true'>"+value.markuprate+"</td><td>"+value.unitcost+"</td><td contenteditable='true'>"+value.vat+"</td><td>"+numeral(grandtotal).format("0,0.00")+"</td></tr>";
