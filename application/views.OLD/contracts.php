...
<div class="main_container">
    ...
    <div class="tabcontainer" id="supplyrequests">
        <div id="deptselector" style="width: auto; clear: both;">
            ...
            <input id="deptnamespan" value="NO DEPT. SELECTED"/>
        </div>
                    ...
                    <div id="tablediv">
                        <table id="supplylisttable">
                            <thead>
                                <tr>
                                 <th col width="8">
                                     <a class='deleterow' onclick='addrow($(this))'><img src='http://localhost/support/assets/images/icons/addicon.png' width='20px' height='20px'></a>   
                                 </th>
                                 <th>No</th>
                                 <th>Item ID</th> 
                                 <th>Part No</th> 
                            ...
                            <tbody id="csrtablebody">
                                <tr>
                                     <td><a class='deleterow' onclick='deleterow($(this))'><img src='http://localhost/support/assets/images/icons/delete.png' width='20px' height='20px'></a></td>
                                    <td class="no">1</td>
...
<div id="csrlistdiv">
    ...
    <fieldset id="csrlistholderdiv">
     ...
     <div id="csrupperdiv">
          <input id="deptnamespan1" value="NO DEPT. SELECTED"/>
