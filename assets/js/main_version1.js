...
// ADD ANOTHER ENTRY ROW ON CSR CREATION TABLE 
function addrow(){
     var rows = $("table#supplylisttable >tbody >tr").length;
...
/*function deleterow(row){
 ...
 $(document).ready(function(e){
  ...
  $("#deptnamespan").val(department.toUpperCase()+" DEPARTMENT");
   $("#deptnamespan1").val(department.toUpperCase()+" DEPARTMENT");
    $.ajax({
        async:true,
        url:"home/countcsr",
         type:"post",
...
var podate = moment($("#podate").val()).format('YYYY-MM-DD');
    var currency = $("#currency option:selected").val();
     var salesperson =  $("#staffname option:selected").text();
      ...
      var rows = $("#supplylisttable tbody tr").length; var grandtotal=0, grandtotalBP=0, itemSP=0, grandtotalSP=0, grandmargin=0, marginrate=0; 
           ...
           for(var i=1;i<=rows;i++){
               ...
               grandtotalBP = grandtotalBP +itemBp;
...
$(document).ready(function(){
    ...
    // alert("staff name: "+techname+" id: "+techid+" phone: "+phone);
        ...
        var newrow ="<tr>\n\
<td><a class='deleterow' onclick='deleterow($(this))'><img src='http://"+domain+"/support/assets/images/icons/delete.png' width='20px' height='20px'></a></td>\n\
...
$.ajax({
      ...
      $("#callstable").DataTable({
              ...
              columns:[
                  {mRender:function(){
              var update = "<a class='updatecall' onclick='updatecall($(this))'><img src='http://"+domain+"/support/assets/images/icons/update.png' width='20px' height='20px'></a>";    
                  return update;
                      }},
                  {mRender:function(){
                   var update = "<a class='deleterow' onclick='deletecall($(this))'><img src='http://"+domain+"/support/assets/images/icons/delete.png' width='20px' height='20px'></a>";    
                  return update;       
                  }},
